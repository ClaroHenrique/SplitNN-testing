...
class ResNet(nn.Module):
    def __init__(self, block, layers, split_point, is_client, num_classes=1000, zero_init_residual=False,
        ...
        # TODO: add is_layer_in_current_model to layers (avoid creation of unused params)
        self.groups = groups
